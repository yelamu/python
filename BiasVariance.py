...
print('fit_theta={}'.format(fit_theta))
#plotData()
...
plt.grid(True)
plt.show()
print('min error_val ={}'.format(np.argmin(errors_val)))
print('min error_val lambda ={}'.format(lambdas[np.argmin(errors_val)]))
